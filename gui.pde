...
public void changeToolAddFluid(GImageToggleButton source, GEvent event) { //_CODE_:toolAddFluid:362552:
    changeMouseMode(MouseMode.ADD_FLUID, source);
} //_CODE_:toolAddFluid:362552:

public void changeToolRemoveFluid(GImageToggleButton source, GEvent event) { //_CODE_:toolRemoveFluid:235465:
...
public void changeToolRepel(GImageToggleButton source, GEvent event) { //_CODE_:toolRepel:256301:
    changeMouseMode(MouseMode.REPEL, source);
} //_CODE_:toolRepel:256301:

public void changeToolAttract(GImageToggleButton source, GEvent event) { //_CODE_:toolAttract:504153:
    changeMouseMode(MouseMode.ATTRACT, source);
} //_CODE_:toolAttract:504153:

public void panel1_Click1(GPanel source, GEvent event) { //_CODE_:addFluidPanel:889065:
...
public void createGUI(){
  ...
  toolAddFluid = new GImageToggleButton(window1, 10, 10, "paint-bucket-icon.png", 2, 1);
  toolAddFluid.addEventHandler(this, "changeToolAddFluid");
  toolRemoveFluid = new GImageToggleButton(window1, 10, 60, "sponge-icon.png", 2, 1);
  ...
  toolRepel = new GImageToggleButton(window1, 10, 160, "repel-icon.png", 2, 1);
  toolRepel.addEventHandler(this, "changeToolRepel");
  toolAttract = new GImageToggleButton(window1, 10, 110, "attract-icon.png", 2, 1);
